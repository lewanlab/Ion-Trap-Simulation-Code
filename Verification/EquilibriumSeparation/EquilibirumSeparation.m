...
for i=1:length(NumberOfIons)
    ...
    lengthScale = ((ionChargeC.^2)/(4*pi*8.85e-12)/(ionMasskg*(axialAngularFreq.^2))).^(1/3);
    ...
    sim.AddAtoms(createIonCloud(1e-3, ions, NumberOfIons(i), 1e-4))
    sim.Add(linearPaulTrap(oscV, endcapV, EndcapZ0, R0, geometricC, Trapfrequency));
