...
%Remove the bath and add laser cooling
 ...
 %This block removes laser cooling and adds neutral heating with backgorund
 %gas He
...
% % This block stores individual RMS velocities at the first half of the last RF cycle
...
VelocitiesCa = [sx_final sy_final sz_final];
