...
%gas He
%NH_Ca = NeutralHeating(Ca40Ions,HeatRate('He',40,Initial_T));
%NH_DarkIon = NeutralHeating(DarkIons,HeatRate('He',DarkMass,Initial_T));
%sim.Add(NH_Ca);%hang-up is occurring here
%sim.Add(NH_DarkIon);
sim.Add(lasercool);
