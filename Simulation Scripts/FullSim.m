...
fprintf(EfileID,'\n');
fprintf(EfileID,'\n');
fprintf(fileID,'LastCavx \r\n');
fprintf(EfileID,'%e ', LastCavx');
fprintf(EfileID,'\n');
fprintf(EfileID,'\n');
fprintf(fileID,'LastCavz \r\n');
...
fprintf(EfileID,'\n');
fprintf(EfileID,'\n');
fprintf(fileID,'LastDarkvx \r\n');
fprintf(EfileID,'%e ', LastDarkvz');
fprintf(EfileID,'\n');
fprintf(EfileID,'\n');
fprintf(fileID,'LastCavy \r\n');
